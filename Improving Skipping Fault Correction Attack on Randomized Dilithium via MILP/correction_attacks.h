...
// This codebase assumes the correction attack is used (CORR_TRIES > 0).
// The CORR_TRIES == 0 (kernel-mode) branch is intentionally not supported.
#if CORR_TRIES <= 0
#error "CORR_TRIES must be > 0 (CORR_TRIES==0 is not supported)."
#endif
