...
CXXFLAGS = $(CFLAGS) -std=c++0x \
           -I/home/haiouc/fplll \
           -I/home/haiouc/fplll/fplll \
           -I/opt/gurobi1300/linux64/include

LDFLAGS = -L/home/haiouc/fplll \
          -L/opt/gurobi1300/linux64/lib

LDLIBS = -lfplll -lntl -lgmp -lmpfr -lgurobi_c++ -lgurobi130
...
test_2_skip: statistics_attack.cpp correction_attacks.cpp .dilithium2_corr
	$(CXX) $(CXXFLAGS) $(CORR_BOUND) -DTESTS=10 -DDILITHIUM_MODE=2 -DFAULT=1 -DSET_Y_ZERO=0 -DSHUFFLING=0 \
        *.o correction_attacks.cpp statistics_attack.cpp \
        $(LDFLAGS) $(LDLIBS) -o test_2_skip 

test_3_skip: statistics_attack.cpp correction_attacks.cpp .dilithium3_corr
	$(CXX) $(CXXFLAGS) $(CORR_BOUND) -DTESTS=10 -DDILITHIUM_MODE=3 -DFAULT=1 -DSET_Y_ZERO=0 -DSHUFFLING=0 \
        *.o correction_attacks.cpp statistics_attack.cpp \
        $(LDFLAGS) $(LDLIBS) -o test_3_skip 

test_5_skip: statistics_attack.cpp correction_attacks.cpp .dilithium5_corr
	$(CXX) $(CXXFLAGS) $(CORR_BOUND) -DTESTS=10 -DDILITHIUM_MODE=5 -DFAULT=1 -DSET_Y_ZERO=0 -DSHUFFLING=0 \
        *.o correction_attacks.cpp statistics_attack.cpp \
        $(LDFLAGS) $(LDLIBS) -o test_5_skip 
...
test_2_skip_shuff: statistics_attack.cpp correction_attacks.cpp .dilithium2_corr_shuff
	$(CXX) $(CXXFLAGS) $(CORR_BOUND) -DTESTS=2 -DDILITHIUM_MODE=2 -DFAULT=1 -DSET_Y_ZERO=0 -DSHUFFLING=1 \
        *.o correction_attacks.cpp statistics_attack.cpp \
        $(LDFLAGS) $(LDLIBS) -o test_2_skip_shuff

test_3_skip_shuff: statistics_attack.cpp correction_attacks.cpp .dilithium3_corr_shuff
	$(CXX) $(CXXFLAGS) $(CORR_BOUND) -DTESTS=2 -DDILITHIUM_MODE=3 -DFAULT=1 -DSET_Y_ZERO=0 -DSHUFFLING=1 \
        *.o correction_attacks.cpp statistics_attack.cpp \
        $(LDFLAGS) $(LDLIBS) -o test_3_skip_shuff

test_5_skip_shuff: statistics_attack.cpp correction_attacks.cpp .dilithium5_corr_shuff
	$(CXX) $(CXXFLAGS) $(CORR_BOUND) -DTESTS=2 -DDILITHIUM_MODE=5 -DFAULT=1 -DSET_Y_ZERO=0 -DSHUFFLING=1 \
        *.o correction_attacks.cpp statistics_attack.cpp \
        $(LDFLAGS) $(LDLIBS) -o test_5_skip_shuff




clean:
	rm -f test_2_skip test_3_skip test_5_skip
	rm -f test_2_skip_shuff test_3_skip_shuff test_5_skip_shuff
	rm -f *.o
